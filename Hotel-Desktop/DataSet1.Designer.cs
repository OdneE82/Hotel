...
namespace Hotel_Desktop {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class BookingDataTable : global::System.Data.TypedTableBase<BookingRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BookingRow AddBookingRow(string RoomType, System.DateTime CheckInDate, System.DateTime CheckOutDate, string CustomerName, string CustomerEmail, string CustomerPhone, string Status) {
...
namespace Hotel_Desktop.DataSet1TableAdapters {
    ...
    public partial class BookingTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Booking] WHERE (([BookingId] = @Original_BookingId) AND ([RoomType] = @Original_RoomType) AND ([CheckInDate] = @Original_CheckInDate) AND ([CheckOutDate] = @Original_CheckOutDate) AND ([CustomerName] = @Original_CustomerName) AND ([CustomerEmail] = @Original_CustomerEmail) AND ([CustomerPhone] = @Original_CustomerPhone) AND ([Status] = @Original_Status))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Booking] ([RoomType], [CheckInDate], [CheckOutDate], [CustomerName], [CustomerEmail], [CustomerPhone], [Status]) VALUES (@RoomType, @CheckInDate, @CheckOutDate, @CustomerName, @CustomerEmail, @CustomerPhone, @Status);
SELECT BookingId, RoomType, CheckInDate, CheckOutDate, CustomerName, CustomerEmail, CustomerPhone, Status FROM Booking WHERE (BookingId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Booking] SET [RoomType] = @RoomType, [CheckInDate] = @CheckInDate, [CheckOutDate] = @CheckOutDate, [CustomerName] = @CustomerName, [CustomerEmail] = @CustomerEmail, [CustomerPhone] = @CustomerPhone, [Status] = @Status WHERE (([BookingId] = @Original_BookingId) AND ([RoomType] = @Original_RoomType) AND ([CheckInDate] = @Original_CheckInDate) AND ([CheckOutDate] = @Original_CheckOutDate) AND ([CustomerName] = @Original_CustomerName) AND ([CustomerEmail] = @Original_CustomerEmail) AND ([CustomerPhone] = @Original_CustomerPhone) AND ([Status] = @Original_Status));
SELECT BookingId, RoomType, CheckInDate, CheckOutDate, CustomerName, CustomerEmail, CustomerPhone, Status FROM Booking WHERE (BookingId = @BookingId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Hotel_Desktop.Properties.Settings.Default.Assignment4ConnectionString;
        }
        ...
        public virtual int Delete(int Original_BookingId, string Original_RoomType, System.DateTime Original_CheckInDate, System.DateTime Original_CheckOutDate, string Original_CustomerName, string Original_CustomerEmail, string Original_CustomerPhone, string Original_Status) {
        ...
        public virtual int Insert(string RoomType, System.DateTime CheckInDate, System.DateTime CheckOutDate, string CustomerName, string CustomerEmail, string CustomerPhone, string Status) {
            if ((RoomType == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string RoomType, System.DateTime CheckInDate, System.DateTime CheckOutDate, string CustomerName, string CustomerEmail, string CustomerPhone, string Status, int Original_BookingId, string Original_RoomType, System.DateTime Original_CheckInDate, System.DateTime Original_CheckOutDate, string Original_CustomerName, string Original_CustomerEmail, string Original_CustomerPhone, string Original_Status) {
            return this.Update(RoomType, CheckInDate, CheckOutDate, CustomerName, CustomerEmail, CustomerPhone, Status, Original_BookingId, Original_RoomType, Original_CheckInDate, Original_CheckOutDate, Original_CustomerName, Original_CustomerEmail, Original_CustomerPhone, Original_Status, Original_BookingId);
        }
    }
